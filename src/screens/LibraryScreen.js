...
export default function LibraryScreen() {
  ...
  return (
    <View className={`flex-1 ${isDark ? "bg-[#0f172a]" : "bg-[#fbf8ff]"}`}>
      ...
      {/* RESTORED: Image-based blurred backgrounds! */}
      <Image
      ...
      <View className="flex-1 bg-transparent" style={{ paddingTop: insets.top }}>
        <ScrollView className="flex-1 px-5 pt-4" showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 100 }}>
          ...
          <Animated.View style={{ opacity: fadeAnim, transform: [{ translateY: slideAnim }] }}>
            ...
            {/* --- TOGGLEABLE COLLECTIONS SECTION --- */}
            <View className="flex-row justify-between items-center mb-4 mt-6">
              ...
              <View className="flex-row items-center">
                ...
                <TouchableOpacity 
                  ...
                  onPress={() => { triggerHaptic(hapticsEnabled, "Light"); setIsGridView(!isGridView); }}
                >
            ...
            <View className={isGridView ? "flex-row flex-wrap justify-between" : "flex-col"}>
              ...
              <TouchableOpacity 
                ...
                onPress={() => navigation.navigate("CollectionScreen", { id: "all", name: "All Quizzes" })}
              >
        ...
        <View style={{ flex: 1, backgroundColor: "rgba(0,0,0,0.6)", justifyContent: "flex-end" }}>
          <View className={`rounded-t-[32px] p-6 pt-8 pb-10 shadow-2xl h-[80%] ${isDark ? "bg-gray-900" : "bg-white"}`}>
            ...
            <TextInput
              ...
              className={`flex-1 p-4 rounded-2xl border mb-6 font-mono text-sm leading-5 ${isDark ? "bg-gray-800 border-gray-700 text-gray-300" : "bg-gray-50 border-gray-200 text-gray-700"}`}
            />
